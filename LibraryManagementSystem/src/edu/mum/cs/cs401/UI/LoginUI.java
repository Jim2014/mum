...
public class LoginUI extends Application {
    ...
    public static void main(String[] args) {
        ...
        Admin admin=new Admin("1","sujan","duminda",addresses ,"12343444",Person.ADMIN);
        admin.setUsername("sujan88");
        admin.setPassword("123");
        LoginController.addPerson(admin);


        Librarian librarian=new Librarian("2","Hung","Jung",addresses ,"322333",Person.LIBRARIAN);
...
//        primaryStage.show();
    ...
    {
//http://stackoverflow.com/questions/11563298/how-to-change-sub-fxml-gui-parts-at-runtime-with-button-click
